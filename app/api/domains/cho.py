...
async def bancho_http_handler() -> Response:
    ...
    return HTMLResponse(
        f"""
<!DOCTYPE html>
<body style="font-family: monospace; white-space: pre-wrap;"> ❤️ RUNNING banchopy-ex MOD BY 4ayo! ❤️
...
<a href="https://github.com/AGXCLIENTS/bancho.py-ex">Source code</a> fork of <a href="https://github.com/osuAkatsuki/bancho.py">bancho.py</a>
</body>
</html>""",
    )
...
WELCOME_MSG = "\n".join(
    (
        ...
        f"We have a community (Discord)[{app.settings.DISCORD_URL}]!",
        "Enjoy the server!",
    ),
)
