...
if app.settings.REDIRECT_OSU_URLS:
    ...
    router.get("/home/account/edit#avatar")(avatar_edit_redirect)
...
# FIX BY 4ayo TO DOMAIN REDIRECTION
@router.get("/")
